...
func printPrimer(output Output, stdout io.Writer) error {
	...
	text := strings.Join([]string{
		...
		"LIST_CARDS => {\"cards\":[{\"id\":\"alpha/card-1\",\"project\":\"alpha\",\"number\":1,\"branch\":\"feature/task\",\"status\":\"Todo\",\"deleted\":false,\"comments_count\":1,\"history_count\":2}]}",
		"GET_CARD => {\"id\":\"alpha/card-1\",\"project\":\"alpha\",\"number\":1,\"branch\":\"feature/task-v2\",\"status\":\"Doing\",\"description\":[{\"timestamp\":\"...\",\"body\":\"...\"}],\"comments\":[{\"timestamp\":\"...\",\"body\":\"...\"}],\"history\":[{\"timestamp\":\"...\",\"type\":\"card.moved\",\"details\":\"...\"}]}",
		"",
		"CARD ID SEMANTICS",
